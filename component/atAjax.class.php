...
* @ingroup 		phpAnvilTools atAjax
*/
class atAjax extends atObjectAbstract {
	/**
	...
	*/
	...
	public function addResponse($sourceID, $actionID, $targetID, $data) {
		$newResponse = new atAjax_Response($sourceID, $actionID, $targetID, $data);
	...
	public function renderHTML () {
		...
		$html .= "\t<script type=\"text/javascript\" src=\"" . $this->jsPath . "atAjax.js\"></script>\n";
