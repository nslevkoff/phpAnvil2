...
* @copyright 	Copyright (c) 2011 Nick Slevkoff (http://www.slevkoff.com)
*/
class atData_postgresql_Connection extends atDataConnectionAbstract implements atDataConnectionInterface
{
	const VERSION		= '1.0';
...
//		}
	...
	public function execute($sql) {
        ...
        $return =  new atData_postgresql_Recordset($sql, $result);
