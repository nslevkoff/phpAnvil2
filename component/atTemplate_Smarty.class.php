...
require_once('atTemplate.abstract.php');
...
* @ingroup 		phpAnvilTools
*/
class atTemplate_Smarty extends atTemplateAbstract {
		...
		switch ($propertyName) {
			case 'theme':
				...
				if ($this->_isConstructed) {
					$this->engine->template_dir = realpath($this->themeRootPath) . '/' . $this->theme . '/';
					$this->addTraceInfo(__FILE__, __METHOD__, __LINE__, 'Template Directory Now Set To ' . $this->engine->template_dir);
				}
				break;
...
//		$this->addTraceInfo(__FILE__, __METHOD__, __LINE__, 'template_dir = ' . $this->engine->template_dir, DevTrace::TYPE_DEBUG);
//		$this->addTraceInfo(__FILE__, __METHOD__, __LINE__, 'compile_dir = ' . $this->engine->compile_dir, DevTrace::TYPE_DEBUG);
//		$this->addTraceInfo(__FILE__, __METHOD__, __LINE__, 'config_dir = ' . $this->engine->config_dir, DevTrace::TYPE_DEBUG);
//		$this->addTraceInfo(__FILE__, __METHOD__, __LINE__, 'cache_dir = ' . $this->engine->cache_dir, DevTrace::TYPE_DEBUG);
