...
require_once('atData_mssql_Column.class.php');
...
* @ingroup 		phpAnvilTools atData atData_MSSQL
*/
class atData_mssql_Recordset extends atDynamicObjectAbstract
...
//                       $firePHP->log($meta);
                       ...
                       $newColumn = new atData_mssql_Column($meta->name, $meta->type);
