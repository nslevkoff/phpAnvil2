...
require_once('atData_postgresql_Column.class.php');
...
* @copyright 	Copyright (c) 2011 Nick Slevkoff (http://www.slevkoff.com)
*/
class atData_postgresql_Recordset extends atDynamicObjectAbstract
...
//                $sql = 'SHOW COLUMNS FROM ';
				...
				while ($i < pg_num_fields($this->result)) {
                   ...
                   $newColumn = new atData_postgresql_Column(pg_field_name($this->result, $i), pg_field_type($this->result, $i));
