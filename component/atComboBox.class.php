...
* @ingroup 		phpAnvilTools
*/
class atComboBox extends atFormControlAbstract {
...
//		$this->addTraceInfo(__FILE__, __METHOD__, __LINE__, 'rendering...', self::TRACE_TYPE_DEBUG);
		...
		$this->addTraceInfo(__FILE__, __METHOD__, __LINE__, $triggers, self::TRACE_TYPE_DEBUG);
...
//        fb::log($this->id, 'renderPreClientScript()');
        ...
        {
            $this->logDebug('Adding onchange trigger...');
